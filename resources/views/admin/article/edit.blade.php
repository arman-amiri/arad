				...
				<div class="row">
					<div class="col-md-8">
						<div class="form">
							...
							<div class="form-group rtl">
								<label>توضیحات</label>
								<textarea name="article" id="article" class="form-control ltr form-control-lg  {{ $errors->has('article') ? 'is-invalid' : '' }}" rows="10" cols="80">
									{{ old('article' , $record->article) }}
								</textarea>
					...
					<div class="col-md-4">
						<div class="form">
							<div class="form-group rtl">
								<img style="width: 100%;" class="index-img" src="{{ asset('images/articles/'.$record->banner) }}">
							</div>
							<div class="form-group rtl">
								<label>تصویر</label>
								<input type="file"
